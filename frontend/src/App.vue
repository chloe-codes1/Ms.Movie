<template>
  <div id="app">
    <nav
      class="navbar navbar-expand-md navbar-light sticky-top d-inline-flex justify-content-between w-100"
      style="background-color:white; box-shadow: 0 2px 2px -2px rgba(0,0,0,.3);"
    >
      <ul
        class="navbar"
